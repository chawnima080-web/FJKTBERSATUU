...
const Home = () => {
    ...
    const targetDate = '2026-02-28T19:00:00';
            ...
            <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 pt-10">
                ...
                >
                    ...
                    <div className="relative inline-block mb-10">
                        ...
                        <p className="relative z-10 text-xl md:text-3xl text-neon-blue font-mono tracking-[0.2em] border-y border-neon-blue/30 py-4 px-10 backdrop-blur-sm">
